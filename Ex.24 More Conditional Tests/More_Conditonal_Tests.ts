...
// • Equality and Inequality Test 2 //
console.log("Inequality test with strings Apple != Orange : ", ("Apple" as string) != "Orange");
...
console.log("Inequality test with numbers  26 !=35 : ", (26 as number) !=35);
...
console.log("AND operator test 5===4 && false : ",(5 as number) === 4 && false); // Output: false
...
console.log("AND operator test 5===4 && 3 > 2 : ",(5 as number) === 4 && 3 > 2); // Output: false
...
console.log("OR operator test 0===1 || 3 > 5 : ",(0 as number) === 1 || 3 > 5); // Output: false
console.log("OR operator test 5===4 || false : ",(5 as number) === 4 || false); // Output: false

// • Test whether an item is in a array //

const fruits:string[]=['PEAR', 'MANGO', 'BANANA', 'GRAPES', 'GUAVA'];
